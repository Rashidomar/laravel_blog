<x-guest-layout>
    <div class="mt-6 bg-gray-100 dark:bg-gray-900">
                  <div class=" px-10 py-6 mx-auto">
                     <div class="max-w-6xl px-10 py-6 mx-auto bg-white dark:bg-gray-800 shadow">
            ...
            <div class="grid grid-cols-12 col-span-12 gap-7">
			 ...
			 <div class="max-w-4xl py-16 xl:px-8 flex justify-center mx-auto ">	        
				<div class="w-full mt-16 md:mt-0 ">
				   <form class="relative z-10 h-auto p-8 py-10 overflow-hidden dark:bg-gray-800  rounded px-7">
					   <h3 class="mb-6 text-center text-lg font-medium text-gray-900 dark:text-gray-100">Write a comment</h3>
					   <textarea type="text" name="comment" class="w-full px-4 py-3 mb-4 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 border border-2 border-transparent border-gray-200 rounded-lg focus:ring focus:ring-blue-500" 
		...
		<div class="max-w-4xl px-10 py-16 mx-auto  dark:bg-gray-800 shadow min-w-screen animation-fade animation-delay  px-0 px-8 mx-auto sm:px-12 xl:px-5">
		        
		        <p class="mt-1 text-2xl font-bold text-left text-gray-900 dark:text-gray-100 sm:mx-6 sm:text-2xl md:text-3xl lg:text-4xl sm:text-center sm:mx-0">
		            All comments on this post
		        </p>
		        <div class="flex  items-center w-full px-6 py-6 mx-auto mt-10 dark:bg-gray-900  rounded-lg sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3">
