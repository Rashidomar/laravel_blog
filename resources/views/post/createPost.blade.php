...
<div class="editor mx-auto flex flex-col dark:bg-gray-800  rounded text-gray-800  p-4 shadow-lg" style="width: 700px;">
    <input class="w-full px-4 py-3 mb-4 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 border border-2 border-transparent border-gray-200 rounded-lg focus:ring focus:ring-blue-500" spellcheck="false" placeholder="Title" type="text">
